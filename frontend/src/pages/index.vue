  ...
  <div class="hero-container bg-grey-darken-4">
    ...
    <v-container class="d-flex justify-space-between align-center py-2 position-relative z-1">
      <div class="d-flex align-center">
        ...
        ></v-img>
        <div>
          <div class="text-subtitle-1 font-weight-bold text-white d-none d-sm-block">
            Almoxarifado UFC
          </div>
    ...
    <v-container class="flex-grow-1 d-flex flex-column justify-center align-center text-center px-4 position-relative z-1">
      <h1 class="text-h4 md:text-h3 font-weight-black text-white mb-2 main-title text-wrap">
        Gestão Inteligente de<br class="d-none d-md-block" />
        <span class="text-warning"> Estoque e Empréstimos</span>
      </h1>

      <p class="text-subtitle-1 md:text-h6 text-grey-lighten-2 font-weight-regular mb-4 subtitle" style="line-height: 1.3;">
      ...
      <v-row class="w-100 justify-center glass-features rounded-xl pa-2 mx-auto" align="stretch">
        <v-col cols="12" md="4" class="d-flex py-1">
          <v-card class="glass-card flex-grow-1 text-center pa-3" border="0" elevation="0">
            <v-icon icon="mdi-package-variant-closed" size="32" color="warning" class="mb-1"></v-icon>
            <h3 class="text-subtitle-1 text-white font-weight-bold mb-1">Inventário</h3>
            <p class="text-caption text-grey-lighten-1" style="line-height: 1.2;">
        ...
        <v-col cols="12" md="4" class="d-flex py-1">
          <v-card class="glass-card flex-grow-1 text-center pa-3" border="0" elevation="0">
            <v-icon icon="mdi-hand-extended-outline" size="32" color="warning" class="mb-1"></v-icon>
            <h3 class="text-subtitle-1 text-white font-weight-bold mb-1">Empréstimos</h3>
            <p class="text-caption text-grey-lighten-1" style="line-height: 1.2;">
        ...
        <v-col cols="12" md="4" class="d-flex py-1">
          <v-card class="glass-card flex-grow-1 text-center pa-3" border="0" elevation="0">
            <v-icon icon="mdi-chart-timeline-variant-shimmer" size="32" color="warning" class="mb-1"></v-icon>
            <h3 class="text-subtitle-1 text-white font-weight-bold mb-1">Transparência</h3>
            <p class="text-caption text-grey-lighten-1" style="line-height: 1.2;">
    ...
    <v-footer class="bg-transparent text-center d-flex flex-column py-2 mt-auto position-relative z-1" elevation="0">
      <div class="text-white text-caption font-weight-bold mb-0">
        Universidade Federal do Ceará - Campus Quixadá
      </div>
      <div class="text-grey-lighten-1 text-caption mb-0" style="font-size: 0.70rem !important;">
        Av. José de Freitas Queiroz, 5003 - Cedro, Quixadá - CE, 63902-580
      </div>
      <div class="text-grey-lighten-1 text-caption mb-0" style="font-size: 0.70rem !important;">
        Contato: (88) 3412-0919 | Site: <a href="https://www.quixada.ufc.br" target="_blank" class="text-warning text-decoration-none">www.quixada.ufc.br</a>
      </div>
      <v-divider class="my-1 w-75 mx-auto border-opacity-25" color="white"></v-divider>
      <div class="text-grey-darken-1 text-caption" style="font-size: 0.65rem !important;">
