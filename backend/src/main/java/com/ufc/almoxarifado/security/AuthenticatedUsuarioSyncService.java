...
public class AuthenticatedUsuarioSyncService {
    ...
    @Transactional
    public void syncFromJwt(Jwt jwt, List<String> roles) {
    ...
    private void createUsuarioFromJwt(Jwt jwt, String email, String username, List<String> roles) {
        ...
        log.info("Usuário criado localmente a partir do Keycloak com papel INDEFINIDO: email={}", email);
    }
    ...
    private String resolveCpf(Jwt jwt) {
        ...
        return generateFallbackCpf(jwt);
    }
